...
export default function BuildScreen() {
  ...
  const handleGenerate = async () => {
    Alert.alert(
      'AI Meal Suggestions',
      'Fill empty meal slots with AI-suggested recipes balanced for nutrition and variety?',
      [
  ...
  const isThisWeek = grid && anchorDate >= grid.weekStart && anchorDate <= grid.weekEnd;
    ...
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          ...
          >
            <Ionicons name="bag-outline" size={14} color={Colors.fgInverse} />
      ...
      <View style={styles.weekNav}>
        ...
        <View style={styles.weekCenter}>
          ...
          {isThisWeek && <Text style={styles.thisWeek}>This Week</Text>}
        </View>
        ...
        >
          {generating ? (
            ...
            <View style={styles.generateBtnInner}>
              <Ionicons name="sparkles" size={14} color={Colors.fgInverse} />
              <Text style={styles.generateText}>AI Suggest Meals</Text>
            </View>
          )}
        </TouchableOpacity>
      </View>
  ...
  return (
    <TouchableOpacity style={slotStyles.filled} onPress={onPress} activeOpacity={0.85}>
      ...
      <View style={slotStyles.filledBody}>
        ...
        <Text style={slotStyles.mealTime}>{(meal.prep_time || 0) + (meal.cook_time || 0)}m</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  groceryText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.fgInverse },
  weekNav: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  weekRange: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: Colors.fgPrimary },
  thisWeek: { fontFamily: 'Inter_600SemiBold', fontSize: 11, color: Colors.accent },
  generateRow: { paddingHorizontal: 20, paddingBottom: 12 },
  generateBtn: {
...
const slotStyles = StyleSheet.create({
  ...
  thumbEmpty: { backgroundColor: Colors.surfacePrimary, alignItems: 'center', justifyContent: 'center' },
  ...
  empty: {
    ...
    padding: 12,
    borderWidth: 1,
    borderColor: 'rgba(140,135,130,0.24)',
    borderStyle: 'dashed',
  },
